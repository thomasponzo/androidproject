package thomasponzo.examenvoorbereiding.Database;
...
public class Database extends SQLiteAssetHelper {
    ...
    public void addToCard(OrderModel order){
        SQLiteDatabase db = getReadableDatabase();
        String query = String.format("INSERT INTO OrderDetail(ProductId,ProductName,Quantity,Price) VALUES('%s','%s','%s','%s','%s');",
                order.getProductId(),
